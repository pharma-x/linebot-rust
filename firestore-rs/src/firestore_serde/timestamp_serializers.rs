...
pub struct FirestoreTimestamp(pub DateTime<Local>);

impl From<DateTime<Local>> for FirestoreTimestamp {
...
pub mod serialize_as_timestamp {
    ...
    where
        D: Deserializer<'de>,
    {
        DateTime::<Local>::deserialize(deserializer)
    }
}
...
pub mod serialize_as_optional_timestamp {
    ...
    where
        D: Deserializer<'de>,
    {
        Option::<DateTime<Local>>::deserialize(deserializer)
    }
}
